...
function App() {
  ...
  const aik2Matches = [
    ...
    { timeAndField: '14:00 - 14:30 (Plan 2)', opponent: 'BP2016:1' },
  ];

  // Boo 16:12:1:s matcher
  const boo16121Matches = [
    { timeAndField: '10:00 - 10:30 (Plan 1)', opponent: 'DIF2016' },
    { timeAndField: '10:50 - 11:20 (Plan 1)', opponent: 'Hammarby2016:1' },
    { timeAndField: '12:30 - 13:00 (Plan 1)', opponent: 'AIK 1' },
    { timeAndField: '13:25 - 13:55 (Plan 1)', opponent: 'BP2016:1' },
  ];

  // Boo 16:12:2:s matcher
  const boo16122Matches = [
    { timeAndField: '10:00 - 10:30 (Plan 2)', opponent: 'BP2016:1' },
    { timeAndField: '10:50 - 11:20 (Plan 2)', opponent: 'Boo 16:13:1' },
    { timeAndField: '12:30 - 13:00 (Plan 2)', opponent: 'AIK 2' },
    { timeAndField: '13:10 - 13:40 (Plan 2)', opponent: 'AIK 1' },
  ];

  // Boo 16:13:1:s matcher
  const boo16131Matches = [
    { timeAndField: '10:00 - 10:30 (Plan 3)', opponent: 'Hammarby2016:1' },
    { timeAndField: '11:30 - 12:00 (Plan 3)', opponent: 'DIF2016' },
    { timeAndField: '12:30 - 13:00 (Plan 1)', opponent: 'Boo 16:12:1' },
  ];

  // Boo 16:13:2:s matcher
  const boo16132Matches = [
    { timeAndField: '10:30 - 11:00 (Plan 4)', opponent: 'Boo 2016:11' },
  ...
  const dif2016Matches = [
    ...
    { timeAndField: '12:30 - 13:00 (Plan 2)', opponent: 'Boo 16:12:2' },
    { timeAndField: '14:00 - 14:30 (Plan 5)', opponent: 'Boo 2016:11' },
  ];
  ...
  const bp20161Matches = [
    ...
    { timeAndField: '13:25 - 13:55 (Plan 1)', opponent: 'Boo 16:12:1' },
  ];

  // Nacka FC:s matcher
  const nackaFCMatches = [
    { timeAndField: '11:30 - 12:00 (Plan 1)', opponent: 'Boo 16:12:2' },
    { timeAndField: '12:30 - 13:00 (Plan 3)', opponent: 'AIK 1' },
    { timeAndField: '13:15 - 13:45 (Plan 4)', opponent: 'Boo 16:13:2' },
  ];

  // Boo 2016:11:s matcher
  const boo201611Matches = [
    { timeAndField: '10:30 - 11:00 (Plan 4)', opponent: 'Boo 16:13:2' },
    { timeAndField: '11:15 - 11:45 (Plan 4)', opponent: 'Hammarby2016:1' },
    { timeAndField: '14:00 - 14:30 (Plan 5)', opponent: 'DIF2016' },
  ];

  // Hammarby2016:1:s matcher
  const hammarby20161Matches = [
    { timeAndField: '10:00 - 10:30 (Plan 3)', opponent: 'Boo 16:13:1' },
    { timeAndField: '10:50 - 11:20 (Plan 1)', opponent: 'Boo 16:12:1' },
    { timeAndField: '13:20 - 13:50 (Plan 5)', opponent: 'AIK 2' },
    { timeAndField: '14:35 - 15:05 (Plan 5)', opponent: 'Boo 16:13:2' },
  ];
