...
const Invitation = () => {
  return (
    <div className="invitation">
      ...
      <p><strong>Foodtruck och försäljning:</strong> Vi är glada att meddela att vi kommer ha en foodtruck på plats under dagen, och dessutom kommer vi att sälja fika och smörgåsar. Det finns alltså goda möjligheter att köpa mat och dryck under dagen.</p>
